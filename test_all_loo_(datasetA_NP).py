...
for method in methods:
	...
	clf_mlp = MLPClassifier(activation='logistic',solver='sgd')
        ...
        scores = cross_val_score(clf_mlp,X_train,  y_train, cv=cv)
	...
	clf_ada = AdaBoostClassifier()
        start_time=time.time()
        scores = cross_val_score(clf_ada,X_train,  y_train, cv=cv)
        end_time=time.time()-start_time
        print "It took: ",end_time
        for i in scores:
                print i
	...
	clf_tree = tree.DecisionTreeClassifier()
        start_time=time.time()
        scores = cross_val_score(clf_tree,X_train,  y_train, cv=cv)
        end_time=time.time()-start_time
        print "It took: ",end_time
        for i in scores:
                print i
	...
	clf_extra = ExtraTreesClassifier()
        start_time=time.time()
        scores = cross_val_score(clf_extra,X_train,  y_train, cv=cv)
        end_time=time.time()-start_time
        print "It took: ",end_time
        for i in scores:
                print i
	...
	clf_random = RandomForestClassifier()
        start_time=time.time()
        scores = cross_val_score(clf_random,X_train,  y_train, cv=cv)
        end_time=time.time()-start_time
        print "It took: ",end_time
        for i in scores:
                print i
	...
	print "Training classifier"
        start_time=time.time()
	scores = cross_val_score(eclf1,X_train,  y_train, cv=cv)
        end_time=time.time()-start_time
        print "It took: ",end_time
        for i in scores:
                print i
